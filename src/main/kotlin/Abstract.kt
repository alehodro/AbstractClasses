...
классов(абстрактных классов, объектов, интерфейсов), через наследование . Создать объект абстрактного класса невозможно. Абстрактные классы
...
для функций, и не иметь инициализации для пропертей. Такие функции и пропертя  должны быть обязательно переопределены
...
С помощью абстрактного класса возможно переопределить открытую не абстрактную функцию и сделать ее абстрактной через
 наследование, для этого при переопределении этой функции нужно добавить ключевое слово abstract.
